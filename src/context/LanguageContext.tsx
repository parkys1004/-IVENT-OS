...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    'search.category.workshop': '워크숍',
    'search.category.lesson': '강습',
    'search.category.instructor': '강사',
    'search.category.dj': 'DJ',
    'search.category.media': '포토/영상',
    'search.category.salsa': '살사',
    'search.category.bachata': '바차타',
    'search.category.kizomba': '키좀바',
    'search.category.salsa_bachata': '살사/바차타',
    'search.category.sal_ba_ki': '살바키',
  ...
  en: {
    ...
    'search.category.workshop': 'Workshop',
    'search.category.lesson': 'Lesson',
    'search.category.instructor': 'Instructor',
    'search.category.dj': 'DJ',
    'search.category.media': 'Photo/Video',
    'search.category.salsa': 'Salsa',
    'search.category.bachata': 'Bachata',
    'search.category.kizomba': 'Kizomba',
    'search.category.salsa_bachata': 'Salsa/Bachata',
    'search.category.sal_ba_ki': 'Salba-Ki',
  ...
  ja: {
    ...
    'search.category.party': '파티',
    'search.category.workshop': 'ワークショップ',
    'search.category.lesson': 'レッスン',
    'search.category.instructor': '講師',
    'search.category.dj': 'DJ',
    'search.category.media': '写真/ビデオ',
    'search.category.salsa': 'サルサ',
    'search.category.bachata': 'バチャータ',
    'search.category.kizomba': 'キゾンバ',
    'search.category.salsa_bachata': 'サルサ/バチャータ',
    'search.category.sal_ba_ki': 'サルバキ',
  ...
  zh: {
    ...
    'search.category.workshop': '研讨会/工作坊',
    'search.category.lesson': '授课',
    'search.category.instructor': '讲师',
    'search.category.dj': 'DJ',
    'search.category.media': '摄影/录像',
    'search.category.salsa': '莎莎',
    'search.category.bachata': '巴恰塔',
    'search.category.kizomba': '奇宗巴',
    'search.category.salsa_bachata': '莎莎/巴恰塔',
    'search.category.sal_ba_ki': '莎巴奇',
    'search.visibility.all': '全部',
  ...
  th: {
    ...
    'search.category.workshop': 'เวิร์ก숍',
    ...
    'search.category.salsa': 'ซัลซ่า',
    'search.category.bachata': 'บาชาต้า',
    'search.category.kizomba': 'คิซอมบ้า',
    'search.category.salsa_bachata': 'ซัลซ่า/บาชาต้า',
    'search.category.sal_ba_ki': 'ซัลบาคิ',
  ...
  vi: {
    ...
    'search.category.kizomba': 'Kizomba',
    'search.category.salsa_bachata': 'Salsa/Bachata',
    'search.category.sal_ba_ki': 'SalBaKi',
