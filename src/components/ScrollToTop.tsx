    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-[100] p-4 bg-indigo-600 text-white rounded-full shadow-2xl shadow-indigo-600/40 hover:bg-indigo-700 transition-colors border border-white/20"
